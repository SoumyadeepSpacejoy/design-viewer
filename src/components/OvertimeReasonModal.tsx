            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full bg-muted/40 border border-border rounded-2xl px-4 py-3 text-foreground placeholder:text-muted-foreground/20 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all resize-none"
                />
              </div>
